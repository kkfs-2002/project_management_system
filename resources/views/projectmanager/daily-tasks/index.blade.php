            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" class="row g-3 mb-4">
                        ...
                        <div class="col-md-2">
                            <label>&nbsp;</label>
                            <a href="{{ route('superadmin.daily-tasks.index') }}" class="btn btn-secondary w-100">Reset</a>
                        </div>
                    </form>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('superadmin.daily-tasks.create') }}" class="btn btn-success">
...
function deleteTask(taskId) {
    if (confirm('Are you sure you want to delete this task?')) {
        fetch(`/superadmin/daily-tasks/${taskId}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            }
