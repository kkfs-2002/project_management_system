                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $developers->count() }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                @php
                                    $presentToday = $attendances->where('date', \Carbon\Carbon::today())->whereNotNull('check_in')->count();
                                @endphp
                                {{ $presentToday }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                @php
                                    $onDuty = $attendances->where('date', \Carbon\Carbon::today())
        ...
        <div class="col-12">
            <div class="card shadow border-0">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-dark">
                            ...
                            Developer Attendance Records
                        </h5>
                        <div class="d-flex gap-2">
                            <!-- Export Button -->
                            <a href="{{ route('superadmin.attendance.export') }}?type=developer" 
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('attendance.developer') }}" class="row g-3">
                                <div class="col-md-3">
                                    <label class="form-label small fw-bold text-muted">Developer</label>
                                    <select name="profile_id" class="form-select form-select-sm">
                                        <option value="">All Developers</option>
                                        @foreach($developers as $dev)
                                            <option value="{{ $dev->id }}" {{ request('profile_id') == $dev->id ? 'selected' : '' }}>
                                                {{ $dev->full_name }} ({{ $dev->employee_id }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 d-flex align-items-end gap-2">
                                    ...
                                    <a href="{{ route('attendance.developer') }}" class="btn btn-sm btn-outline-secondary">
                    ...
                    @if($attendances->isEmpty())
                        <div class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <p class="text-muted mb-4">No developers have recorded attendance for the selected filters</p>
                                <a href="{{ route('attendance.developer') }}" class="btn btn-primary">
                                            ...
                                            @else
                                                @if($attendance->check_in)
                                                    <span class="badge bg-info-light text-info">
                                                        <i class="fas fa-code me-1"></i> Still Coding
                                                    </span>
                                                @else
...
function markAsCheckedOut(id) {
    if(confirm('Are you sure you want to mark check out for this developer?')) {
