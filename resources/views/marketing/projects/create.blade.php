...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('marketing.projects.store') }}" method="POST">
                        @csrf
    ...
    <select id="contact_method" name="contact_method"
        ...
        <option value="phone_call" {{ old('contact_method') == 'phone_call' ? 'selected' : '' }}>Phone Call</option>
        ...
        <option value="in_person" {{ old('contact_method') == 'in_person' ? 'selected' : '' }}>In-Person Meeting</option>
        <option value="video_call" {{ old('contact_method') == 'video_call' ? 'selected' : '' }}>Video Call</option>
        <option value="social_media" {{ old('contact_method') == 'social_media' ? 'selected' : '' }}>Social Media</option>
        <option value="website_inquiry" {{ old('contact_method') == 'website_inquiry' ? 'selected' : '' }}>Website Inquiry</option>
    </select>
    ...
    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" name="project_price"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="first_call_date" class="form-control"
                                    value="{{ old('first_call_date') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">2nd Call Date</label>
                                <input type="date" name="second_call_date" class="form-control"
                                    value="{{ old('second_call_date') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">3rd Call Date</label>
                                <input type="date" name="third_call_date" class="form-control"
                                    value="{{ old('third_call_date') }}">
                            </div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        loadCategories("{{ old('project_type') }}", "{{ old('project_category') }}");
    });
</script>
@endsection
