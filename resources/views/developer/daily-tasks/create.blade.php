        ...
        <div class="col-12 col-lg-10">
            <div class="form-container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('developer.daily-tasks.index') }}" class="btn btn-outline-secondary">
                ...
                @endif
                <form action="{{ route('developer.daily-tasks.store') }}" method="POST">
                    @csrf
