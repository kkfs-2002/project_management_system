...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('layouts.projectmanager') }}">
                <img src="{{ asset('NetIT logo.png') }}" alt="PM" style="width:40px; height:40px;">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="tasksDropdown">
                            <li><a class="dropdown-item" href="{{ route('projectmanager.tasks.index') }}">View Assigned Tasks</a></li>
                        </ul>
